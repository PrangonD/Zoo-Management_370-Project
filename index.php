	...
	<div id="wrapper" class="home-page">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-sm-9">
						...
						<p>Welcome to Zoo Chittagong. Have a look around the website. You'll find everything lovely animals and you'll also be able to purchase tickets </p>
					</div>
		...
		<section id="content">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="aligncenter"><h2 class="aligncenter">Our Best Animals</h2>We have almost all the animals in town and the most rarest ones as well. Scroll Along</div>
						<br/>
					</div>
				</div>
